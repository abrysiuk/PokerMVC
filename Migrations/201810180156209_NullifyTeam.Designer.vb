...
Namespace Migrations
    ...
    Public NotInheritable Partial Class NullifyTeam
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(NullifyTeam))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201810180156209_NullifyTeam"
            End Get
        End Property
