...
Public Class ApplicationUserManager
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationUserManager), context As IOwinContext) As ApplicationUserManager
        Dim manager = New ApplicationUserManager(New UserStore(Of ApplicationUser)(context.Get(Of DAL.PokerContext)()))
        ...
        Dim roleManager = New RoleManager(Of IdentityRole)(New RoleStore(Of IdentityRole)(New DAL.PokerContext))
